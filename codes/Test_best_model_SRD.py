...
SAVE_PATH = '/ghome/zhuyr/AAAI22_shadow_removal/SRD.pth'
test_results_path = '/gdata1/zhuyr/Derain_torch/AAAAA_Results_SRD/'
if not os.path.exists(test_results_path):
    os.mkdir(test_results_path)

val_in_path = "/gdata1/zhuyr/Derain_torch/shadow_SRD_test/shadow_re/"
val_gt_path = "/gdata1/zhuyr/Derain_torch/shadow_SRD_test/shadow_free_re/"
val_mask_path = "/gdata1/zhuyr/Derain_torch/shadow_SRD_test/shadow_mask_re/"
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        print('Average psnr on SRD dataset',total_psnr/len(eval_loader))
